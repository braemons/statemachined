...
class StateMachineConfigSummary(_message.Message):
    __slots__ = ("name", "readable", "detail", "description", "board", "graph_names")
    NAME_FIELD_NUMBER: _ClassVar[int]
    READABLE_FIELD_NUMBER: _ClassVar[int]
    DETAIL_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, name: _Optional[str] = ..., readable: _Optional[bool] = ..., detail: _Optional[str] = ..., description: _Optional[str] = ..., board: _Optional[str] = ..., graph_names: _Optional[_Iterable[str]] = ...) -> None: ...
